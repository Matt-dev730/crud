...
<!DOCTYPE html>
	...
	<html>
		...
		<head>
			...
			<link href="CSS/NouvelUtilisateur.css" rel="stylesheet"/>
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<ul class="navbar-nav mr-auto">
								...
								<li class="nav-item active">
									...
									<a class="nav-link" href="NouvelUtilisateur.jsp">S'inscrire</a>
						...
						<h1>Veuillez remplir les champs suivants:</h1>
							...
							<form  action="addUser" method="post">
								...
								<div class="inputbox">
									...
									<input type="text" name="Nom" class="nom" required="required"/>
									<label>Nom:</label>
								...
								<div class="inputbox">
									...
									<input type="password" name="Mp" class="mp" required="required"/>
								...
								<div class="inputbox">
									...
									<input type="password" name="ConfirmMp" class="confirmmp" required="required"/>
								...
								<div class="inputbox">
									...
									<input type="email" name="Email" class="mail" required="required"/>
									<label>Email:</label>
								
								</div>
								<div class="inputbox">
								
									<input type="text" name="Telephone" class="telephone" required="required"/>
									<label>Telephone:</label>
								
								</div>
								<div class="inputbox">
								
									<input type="text" name="Adresse" class="adresse" required="required"/>
									<label>Adresse:</label>
								
								</div>
								<div class="inputbox">
								
									<input type="text" name="CodePostal" class="cp" required="required"/>
								...
								<div class="inputbox">
									...
									<input type="text" name="Ville" class="ville" required="required"/>
									<label>Ville:</label>
									...
									<p><input type="checkbox" id="checkbox"/> Je ne suis pas un robot</p>
									
									<br>
									
									<p><input type="submit" value="S'inscrire"/> Vous avez déjà un compte ? <a href="Login.jsp">Connexion</a>
