...
<!DOCTYPE html>
	...
	<html>
		...
		<head>
			...
			<link href="CSS/MsgTransmit.css" rel="stylesheet"/>
		...
		<div class="containt">
			...
			<article>
				...
				<div class="msg">
					...
					<p>Nous vous remercions pour votre message qui nous a bien était transmit.<br>
					Nous traiterons votre demande et reviendrons vers vous le plus rapidement possible.</p>
					
					<a href="Home.jsp">Retour à l'acceuil</a>
