			...
			<header>	
				...
				<article>
					...
					<div class="form">
							...
							<h3>Veuillez formuler votre demande nous vous répondront dans les plus bref délais.</h3>
						...
						<div class="mail">
							...
							<form action="contact" method="post">
									...
									<input type="email" name="Mail" placeholder="Votre mail" required="required"/>
									
									<br>
									
									<input type="text" name="Objet" placeholder="Intitulé de votre demande" required="required"/>
									
									<br>
									
									<textarea rows="30" cols="10" class="requete" name="Message" placeholder="Votre demande"></textarea>
